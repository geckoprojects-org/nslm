 ...
 */
package org.example.serviceloader.clash.caller;
...
/**
 * Calls {@code ServiceLoader.load(Greeter.class)} for Greeter 1.0, without a class
 ...
 */
@Component(service = Function.class, property = "clash.api=1.0")
public class ClashCaller implements Function<String, List<String>> {
	...
	public List<String> apply(String tccl) {
		...
		if ("bundle".equals(tccl)) {
			thread.setContextClassLoader(ClashCaller.class.getClassLoader());
		}
		try {
